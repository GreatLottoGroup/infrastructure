...
abstract contract ERC721Permit is ERC721, IERC721Permit {
    ...
    /**
     * @dev ERC721Permit: approval to current owner.
     */
    error ERC721PermitNoNeedApprove(address spender, address owner);
    ...
    function permit(
        ...
        if(spender == owner){
            revert ERC721PermitNoNeedApprove(spender, owner);
        }
